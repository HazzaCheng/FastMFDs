    ...
    for (low <- 2 to middle) {
      ...
      for (col <- 1 to cols) {
        ...
        if (low < high) {
          ...
          println("====== High Level: " + high + " Col: " + col + " Cut: " + (CandidatesUtils.getToCheckedSize(toCheckedHigh) - size))
        ...
        println("====== Low Level: " + high + " Col: " + col + " Cut: " + (CandidatesUtils.getToCheckedSize(toCheckedLow) - size))
        if (size > 0 && size <= THRESHOLD) {
